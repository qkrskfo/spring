				...
				<table border=0 cellpadding=0 cellspacing=0>
					<tr>
						<td><br />
							...
							<form name="f" method="post" action="order_delete_action">
								<input type="hidden" name="j_no" value="${order.o_no}">
								<table align="center" width="80%"  border="0" cellpadding="0" cellspacing="1"  bgcolor="BBBBBB" >
									...
									<tr>
										<td width=290 height=26 align=center bgcolor="ffffff" class=t1>${order.o_no}</td>
										<td width=112 height=26 align=center bgcolor="ffffff" class=t1>${order.o_date}</td>
										<td width=166 height=26 align=center bgcolor="ffffff" class=t1>${order.userId}</td>
								...
								<table align=center  width=80% border="0" cellpadding="0" cellspacing="1"  bgcolor="BBBBBB" >
									...
									<c:set var="tot_price"  value="${tot_price + orderItem.oi_qty * orderItem.product.p_price}"/>
									<tr>
										<td width=290 height=26 align=center  bgcolor="ffffff" class=t1>
										<a href='product_detail?p_no=${orderItem.product.p_no}'>
										${orderItem.product.p_name}</a>
										</td>
										...
										<s:eval expression="new java.text.DecimalFormat('#,###').format(orderItem.oi_qty*orderItem.product.p_price)"/>
										</td>
									...
									<tr>
										<td width=640 colspan=4 height=26  bgcolor="ffffff" class=t1>
											...
											<p align=right style="padding-top: 10px">
												<font color=#FF0000>총 주문 금액 : <s:eval expression="new java.text.DecimalFormat('#,###.0').format(tot_price)"/> 원
												</font>
											</p>
										</td>
									</tr>
