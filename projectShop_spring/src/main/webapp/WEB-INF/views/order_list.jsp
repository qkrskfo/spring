...
<script type="text/javascript">
	function order_delete_all_action(){
		document.order_delete_all_form.action='order_delete_all_action';
						...
						<td><br />
							...
							<form name="f" method="post">
								<table align=center width=80% \border="0" cellpadding="0"
									...
									<tr>
										<td width=145 height=26 align=center bgcolor="ffffff" class=t1>${order.o_no}</td>
										<td width=145 height=26 align=center bgcolor="ffffff" class=t1>${order.o_desc}</td>
										<td width=112 height=26 align=center bgcolor="ffffff" class=t1>
										<s:eval expression="new java.text.SimpleDateFormat('yyyy/MM/dd').format(order.o_date)"/> 
										</td>
										<td width=136 height=26 align=center bgcolor="ffffff" class=t1>
										<s:eval expression="new java.text.DecimalFormat('#,###').format(order.o_price)"/>
										</td>
										<td width=80 height=26 align=center bgcolor="ffffff" class=t1><a
											href="order_detail?o_no=${order.o_no}" class=m1>주문상세</a></td>
									</tr>
									</c:forEach>
