...
<script type="text/javascript">
	function review_modify() {
		...
		if (f3.reviewComment.value == "") {
			alert("감상평을 입력하십시요");
			f.reviewComment.focus();
			return false;
		}
		f3.action = "review_modify_action";
		f3.submit();
	}

	function modify_cancel() {
		location.href = "movie-info?movieNo="+ ${review1movie.movie.movieNo};
	}
</script>
<body>
	...
	<div class="section-line" style="padding: 20px 20px 20px 25px;">
                            ...
                            <form autocomplete="off" name="f3">
                                ...
                                <div class="row form-grid">
                                    ...
                                    <div class="col-12">
                                        <button class="px-5 btn btn-theme" type="button" onclick="review_modify()">수정</button>
                                        <button class="px-5 btn btn-theme" type="button" onclick="modify_cancel()">취소</button>
                                    </div>
                                </div>
                            </form>
                        </div>
