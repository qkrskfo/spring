...
<head>
	<meta charset="UTF-8">
	<title>Little-cinema 로그인&회원가입</title>
									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group">
												<input type="text" name="id" value="${fmember.id}"  class="form-style" placeholder="아이디" id="id" autocomplete="off">
												<i class="input-icon uil uil-at"></i>
											</div>	
											<div class="form-group mt-2">
												<input type="password" name="password" value="${fmember.password}" class="form-style" placeholder="비밀번호" id="password" autocomplete="off">
												<i class="input-icon uil uil-lock-alt"></i>
											</div>
											<input type="button" class="btn mt-4" value="로그인" onclick="login();">
                            				<!-- 
