...
<head>
	...
	<!-- <link rel="stylesheet" href="test_trash/owl.carousel.min.css">
	<link rel="stylesheet" href="test_trash/slider-radio.css">
	<link rel="stylesheet" href="test_trash/select2.min.css">
	<link rel="stylesheet" href="test_trash/plyr.css"> -->

	<link rel="stylesheet" href="css/magnific-popup.css">
	<link rel="stylesheet" href="css/main.css">

	<!-- Favicons(favorites + icon) 웹사이트나 웹페이지를 대표하는 아이콘 -->
...
<body>
				...
				<div class="col-12">
					<div class="profile">
						...
						<ul class="nav nav-tabs profile__tabs" id="profile__tabs" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#tab-2" role="tab" aria-controls="tab-2" aria-selected="false">예매 내역</a>
							</li>

							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#tab-3" role="tab" aria-controls="tab-3" aria-selected="false">정보 수정</a>
							</li>
						</ul>
						<!-- end tabs nav -->
				...
				<div class="tab-pane fade show active" id="tab-1" role="tabpanel">
					<div class="row row--grid">
						...
						<div class="col-12 col-sm-6 col-xl-3">
							<div class="stats">
								<span>이름 <a href="#modal-topup" class="open-modal">modal top up</a></span>
						...
						<div class="col-12 col-sm-6 col-xl-3">
							<div class="stats">
								<span>생년월일</span>
								<p><a href="#"><fmt:formatDate value="${loginMember.birth_date }" pattern="yyyy-MM-dd" /></a></p>
								...
								<div class="row">
									...
									<div class="col-12 col-lg-6">
										<form action="#" class="sign__form sign__form--profile sign__form--first">
											<div class="row">
												<div class="col-12">
													<h4 class="sign__title">개인 정보 수정</h4>
												</div>

												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													<div class="sign__group">
														<label class="sign__label" for="username">아이디</label>
														<input id="username" type="text" name="username" class="sign__input" placeholder="Member">
													</div>
												</div>

												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													<div class="sign__group">
														<label class="sign__label" for="email">이름</label>
														<input id="email" type="text" name="email" class="sign__input" placeholder="홍길동">
													</div>
												</div>

												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													<div class="sign__group">
														<label class="sign__label" for="firstname">휴대전화</label>
														<input id="firstname" type="text" name="firstname" class="sign__input" placeholder="010-0000-0000">
													</div>
												</div>

												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													<div class="sign__group">
														<label class="sign__label" for="lastname">생년월일</label>
														<input id="lastname" type="text" name="lastname" class="sign__input" placeholder="1970-01-01">
													</div>
												</div>

												<div class="col-12">
													<button class="sign__btn" type="button">저장하기</button>
												</div>
											</div>
										</form>
									</div>
									...
									<div class="col-12 col-lg-6">
										<form action="#" class="sign__form sign__form--profile">
											<div class="row">
												...
												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													<div class="sign__group">
														<label class="sign__label" for="oldpass">기존 비밀번호</label>
												...
												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													<div class="sign__group">
														<label class="sign__label" for="newpass">새 비밀번호</label>
												...
												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													<div class="sign__group">
														<label class="sign__label" for="confirmpass">새 비밀번호 확인</label>
												...
												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													<div class="sign__group">
														<label class="sign__label" for="select">시불 뭘 선택하라는겨</label>
												...
												<div class="col-12">
													<button class="sign__btn" type="button">변경하기</button>
												</div>
											</div>
										</form>
									</div>
	...
	<!-- <script src="test_trash/plyr.min.js"></script>
	<script src="test_trash/slider-radio.js"></script>
