...
<footer class="section-text-white footer footer-links bg-darken"></footer>
    ...
    <div class="row">
        <div class="col-sm-6 col-lg-3">
            ...
            <div class="footer-content">
                <p class="footer-text">서울특별시 강남구 테헤란로 124 4층
                    <br/>(역삼동, 삼원타워)</p>
                <p class="footer-text">Call us:&nbsp;&nbsp;02-6255-8002</p>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
