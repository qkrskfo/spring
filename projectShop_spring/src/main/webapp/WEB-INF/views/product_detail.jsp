							...
							<table style="margin-left: 10px" border=0 width=80% height=376
								...
								<tr width=100%>
									...
									<td width=40% height=200 align=center><img border=0
										src='image/${product.p_image}' width=120 height=200></td>
									<td width=30% height=200 class=t1>
										<ol type="disc">
											<li><b>견종 : ${product.p_name}&nbsp;&nbsp;&nbsp;
											</b></li>
											<li><font color=#FF0000>가격 : ${product.p_price}&nbsp;&nbsp;&nbsp;
											</font></li>
											<li><font color=#0000FF>${product.p_desc}</font></li>
										</ol>
									</td>
								</tr>
								<tr>
